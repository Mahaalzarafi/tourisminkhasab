...
public class Myada extends RecyclerView.Adapter<myviHolder> {
    Context context;
    List<MyItemr> items;

    public Myada(List<MyItemr> items){
    ...
    public myviHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new myviHolder(LayoutInflater.from(context).inflate(R.layout.re_item,parent,false));
    }
